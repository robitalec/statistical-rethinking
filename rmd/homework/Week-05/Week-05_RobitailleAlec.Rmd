...
')
prior_stan_file <- write_stan_file(prior_stan)
prior_stan_model <- cmdstan_model(prior_stan_file)
prior_stan_model_sample <- prior_stan_model$sample(data = list(N = c(1, 2)))
```
