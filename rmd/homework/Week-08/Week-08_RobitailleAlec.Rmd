...
mcmc_trace(model_trolley_draws)
mcmc_areas(model_trolley_draws, regex_pars = 'alpha', transformations = inv.logit)
mcmc_areas(model_trolley_draws, pars = c('alpha_bar', 'sigma'))
```
