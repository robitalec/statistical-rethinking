...
```{cmdstan, output.var = 'q1_model_department'}
data {
  int<lower=0> N;
  int<lower=0> N_gender;
...
```{r}
q1_stan <- 'q1_department.stan'
writeLines(readLines(q1_stan))
q1_model_department <- cmdstan_model(q1_stan)

q1_sample <- q1_model_department$sample(data = q1_data)
